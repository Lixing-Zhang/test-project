        ...
        <nav x-data="{ open: false }" class="bg-gray-800">
            ...
            <div x-description="Mobile menu, show/hide based on menu state." class="md:hidden" id="mobile-menu"
                ...
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                    <a href="{{ route('contacts') }}"
                        class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">Contacts</a>
                    ...
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            {{-- <img class="h-10 w-10 rounded-full"
                                src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&amp;ixqx=JqQLk7ZBrk&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=2&amp;w=256&amp;h=256&amp;q=80"
                                alt=""> --}}
                        </div>
                        <div class="ml-3">
